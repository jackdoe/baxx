...
What: 
  baxx.dev is a dead simple backup as a service
  with unix philosophy in mind
  ...
  and not storage availability, if someone tells 
  you 99.9999% availability is important for backups, 
  they are lying to you.

Why:
  because I want to explore the idea of building
  a service without a website, share it with my
  friends and have fun

How:
  alpha is just on digitalocean, but the beta will
  be on dedicated servers from hetzner.com

Cost:
  the alpha costs 5E per month for few GB
  much more than you would buy google drive or
  dropbox or anything

  ultimately you should be able to get 5E per 1tb
